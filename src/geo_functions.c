...
/**
 * geo_lookup_location - Given IP address (e.g. "222.255.77.113" returns JSON with location info.
...
/**
 * geo_lookup_timezone - Given IP address (e.g. "198.101.119.34"), returns JSON with timezone info.
